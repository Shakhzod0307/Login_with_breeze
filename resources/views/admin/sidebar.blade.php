        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{route('admin.add.property')}}" class="nav-link">Add Property</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="advancedUI">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('admin.all.amenity')}}" class="nav-link">All Amenity</a>
                </li>
                <li class="nav-item">
                  <a href="{{route('admin.add.amenity')}}" class="nav-link">Add Amenity</a>
                </li>
              </ul>
            </div>
          </li>
